<template>
  <div class="page-hero" v-if="model">
    <div class="topbar bg-black py-2 px-3 d-flex jc-center text-white">
          ...
          <div>
            ...
            <m-card plain icon="menu1" title="英雄关系">
              ...
              <div class="d-flex pt-3" v-for="item in model.partners" :key="item.name">
                <img :src="item.hero.avatar" alt="" height="50" style="border: 1px solid #258df2; border-radius: 0 10px 0 10px">
